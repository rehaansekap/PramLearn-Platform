...
const QuizListHeader = ({ totalQuizzes }) => {
  return (
    <>
      {/* Breadcrumb */}
      {/* <Breadcrumb
      ...
      >
        ...
        <Row align="middle" style={{ position: "relative", zIndex: 1 }}>
          <Col xs={24} md={18}>
            ...
            >
              Kerjakan kuis untuk mengukur pemahaman Anda
            </Text>
            <Text
              style={{
            ...
            >
              Total {totalQuizzes} kuis tersedia
            </Text>
          </Col>
          <Col xs={24} md={6} style={{ marginTop: 16, textAlign: "center" }}>
            ...
            >
              ...
              <div style={{ fontSize: 14, opacity: 0.9 }}>Pusat Penilaian</div>
            </div>
          </Col>
        </Row>
      </div>
