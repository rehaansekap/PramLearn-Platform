...
urlpatterns = [
    ...
    path('api/student/analytics/', StudentGradeAnalyticsView.as_view(),
    ...
    path('api/student/assignment-feedback/grade/<int:grade_id>/',
         AssignmentFeedbackByGradeView.as_view(), name='assignment-submission-feedback'),
    path('api/student/quiz-review/<int:attempt_id>/',
         QuizReviewView.as_view(), name='quiz-review'),
    path('api/student/group-quiz-review/<int:attempt_id>/',
         GroupQuizReviewView.as_view(), name='group-quiz-review'),
    ...
    path('api/student/upcoming-deadlines/',
         StudentUpcomingDeadlinesView.as_view(), name='student-upcoming-deadlines'),
