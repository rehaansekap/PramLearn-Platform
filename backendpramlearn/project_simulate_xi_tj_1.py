...
def generate_users():
    ...
    # 36 Students from XI TJ 1.csv
    students_data = [
        ("adi_n", "Adi", "Nugroho"),
        ("aditya_d_p", "Aditya Dwi", "Prasetyo"),
        ("ahmad_n_a", "Ahmad Nur", "Arifin"),
        ("aida_n", "Aida", "Nuraini"),
        ("ajeng_s_d", "Ajeng Sekar", "Diani"),
        ("aji_s", "Aji", "Saputro"),
        ("al_fathir_a", "Al-Fathir", "Akbar"),
        ("aldi_s", "Aldi", "Saputra"),
        ("alvin_d_p", "Alvin Dwi", "Pradana"),
        ("amanda_d_a", "Amanda Dwi", "Aprilia"),
        ("amelia_p", "Amelia", "Putri"),
        ("andre_f", "Andre", "Firmansyah"),
        ("andrian_f", "Andrian", "Firmansyah"),
        ("anggun_s", "Anggun", "Safitri"),
        ("anisa_r", "Anisa", "Rahmadani"),
        ("aril_s", "Aril", "Syaputra"),
        ("bella_s", "Bella", "Safitri"),
        ("bima_a_s", "Bima Adi", "Saputra"),
        ("cindy_a", "Cindy", "Aulia"),
        ("dani_a", "Dani", "Ardiansyah"),
        ("davin_a", "Davin", "Ardiansyah"),
        ("della_a_s", "Della Ayu", "Saputri"),
        ("desta_a_s", "Desta Adi", "Saputra"),
        ("devi_a", "Devi", "Aprilliana"),
        ("dicky_p", "Dicky", "Prasetyo"),
        ("dwi_p", "Dwi", "Pangestu"),
        ("elsa_f_d", "Elsa Fitri", "Dianti"),
        ("fajar_a", "Fajar", "Ariansyah"),
        ("fajar_s", "Fajar", "Saputra"),
        ("farrel_a_p", "Farrel Aditya", "Putra"),
        ("fina_a", "Fina", "Amelia"),
        ("fitra_a_s", "Fitra Adhi", "Saputra"),
        ("galang_p", "Galang", "Prasetyo"),
        ("galih_p_s", "Galih Puji", "Santoso"),
        ("m_rizky_f", "Muhammad Rizky", "Fauzan"),
        ("nabil_f", "Nabil", "Firmansyah"),
    ]
    ...
    with open("student_passwords.txt", "w", encoding="utf-8") as f:
        f.write("STUDENT LOGIN CREDENTIALS - XI TJ 1\n")
        f.write("=" * 50 + "\n")
...
def main():
    ...
    print("    - Quiz 1: Instrumen Soal Jaringan Komputer (40 soal)")
